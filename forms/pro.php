  ...
  <body>
    ...
    <div class="basis text-light">
      ...
      <ul>
        ...
        <li>1 maanden gratis onderhoud</li>
      </ul>
      ...
      En voor onderhoud komt er nog 35euro/maand bij.</p>
    </div>
    <fieldset>
          ...
          <div class="form-check">
            ...
            <div class="form-group">
              ...
              <div class="form-check">
                ...
                <label class="form-check-label"  for="contact">ja (extra: 35euro/jaar) </label>
              </div>
              <div class="form-check">
