...
<div class="basis text-light">
  <h3 class="fw-light">Basismodel</h3>
  ...
  En voor onderhoud komt er nog 20euro/maand bij.</p>
</div>
<fieldset>
  <form class="contact-form" action="../php/prijzen.php" method="post">
      ...
      <div class="form-check">
        ...
        <div class="form-group">
          ...
          <div class="form-check">
            ...
            <label class="form-check-label"  for="contact">ja (extra: 20euro/jaar) </label>
          </div>
          <div class="form-check">
